...
C {devices/lab_pin.sym} 270 -170 3 0 {name=p12 sig_type=std_logic lab=CLK}
C {devices/lab_pin.sym} 770 -450 1 0 {name=p13 sig_type=std_logic lab=CLK}
C {devices/lab_pin.sym} 60 -150 0 0 {name=p16 sig_type=std_logic lab=CLK}
