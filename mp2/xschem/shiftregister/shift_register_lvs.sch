...
C {devices/lab_pin.sym} 70 -200 0 0 {name=p4 sig_type=std_logic lab=A}
...
C {/home/madvlsi/dev/git/vlsi/mp2/xschem/shiftregister/shift_register_inverter_2.sym} 150 -200 0 0 {name=x7}
C {madvlsi/vdd.sym} 120 -230 0 0 {name=l1 lab=VDD}
C {madvlsi/gnd.sym} 120 -170 0 0 {name=l2 lab=GND}
