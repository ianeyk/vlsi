...
S {}
E {}
T {Simulation Output Folder 3} 340 -340 0 0 0.3 0.3 {}
N 10 -100 10 -80 {
lab=#net1}
N 10 -100 580 -100 {
lab=#net1}
...
C {madvlsi/vdd.sym} 580 -300 0 0 {name=l14 lab=VDD}
C {madvlsi/vdd.sym} 930 -300 0 0 {name=l15 lab=VDD}
...
C {madvlsi/pmos3.sym} 580 -270 0 1 {name=M1
L=0.5
W=12
body=VDD
nf=1
...
C {madvlsi/pmos3.sym} 830 -270 0 1 {name=M2
L=0.5
W=12
body=VDD
nf=1
...
C {madvlsi/pmos3.sym} 680 -270 0 0 {name=M3
L=0.5
W=12
body=VDD
nf=1
...
C {madvlsi/vdd.sym} 680 -300 0 0 {name=l2 lab=VDD}
C {madvlsi/pmos3.sym} 930 -270 0 0 {name=M4
L=0.5
W=12
body=VDD
nf=1
...
C {madvlsi/pmos3.sym} 830 -190 0 1 {name=M6
L=0.5
W=12
body=VDD
nf=1
...
C {madvlsi/pmos3.sym} 680 -190 0 0 {name=M7
L=0.5
W=12
body=VDD
nf=1
...
C {madvlsi/pmos3.sym} 930 -190 0 0 {name=M8
L=0.5
W=12
body=VDD
nf=1
...
C {devices/lab_pin.sym} -130 -10 2 0 {name=p21 sig_type=std_logic lab=Vcn}
C {devices/lab_pin.sym} 750 -190 3 0 {name=p22 sig_type=std_logic lab=Vcn}
